...
1.中国基本面:
    Hyper parameter:
        ...
        random_seed: 273
    Result:
        val accuracy_score: 0.5263157894736842
        val auc: 0.5366004962779157
    Feature importance:
...
2.美国基本面:
    Hyper parameter:
        ...
        random_seed: 274
    Result:
        val accuracy_score: 0.4935064935064935
        val auc: 0.5021748912554372
    Feature importance:
...
3.中国基本面 + 美国涨跌:
    Hyper parameter:
        ...
        random_seed: 273
    Result:
        val accuracy_score: 0.543859649122807
        val auc: 0.5496277915632755
    Feature importance:
        {'oi_chg': 0.36872435809142856, 'MA': 0.43284683923333345, 'EXPMA': 0.3691968628649999, 'MACD': 0.5335974546999999, 'close': 0.37309008646216224, 'KDJ': 0.6748949445636363, 'ADTM': 0.3099554760699999, 'oi': 0.3524929716178571, 'volume': 0.3398606367620834, 'BIAS': 0.35116056692222225, 'open': 0.24076164518181817, 'low': 0.29136689967142854, 'high': 0.20363715952500003}
"""
...
model = GRU(input_size=input_size, output_size=32, classification=True)
