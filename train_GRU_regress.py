...
3.中国基本面 + 美国涨跌:
    Hyper parameter:
        ...
        random_seed: 273
    Result:
        val mse: 0.05438308886226347
        test mse: 0.061160180408077136
...
model = GRU(input_size=input_size, output_size=32, num_classes=1, classification=True)
...
df.to_csv('./out/GRU_result_zh.csv', index=False)
